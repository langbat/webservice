 ...
 */
class TransferFunds extends MY_Controller {
    ...
    public function index() {
        ...
        $destinationAccount = new soapId(@$data['destinationAccount']['id'], @$data['destinationAccount']['referenceId']);

        $res = $soapFunds->validateAccount(new authorization(), @$data['subscriberId'], $sourceAccountId, $destinationAccount, $data, 'transfer');
        $res = (array) $res;
